...
class _SelectRoleWidgetState extends State<SelectRoleWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'select_role'});
  }
                ...
                Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SELECT_ROLE_PAGE_PROFESSOR_BTN_ON_TAP');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('SELECT_ROLE_PAGE_ALUNO_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');

                        context.pushNamed('loginRegister_global');
                      },
                      text: 'ALUNO',
                      options: FFButtonOptions(
                        width: 120.0,
